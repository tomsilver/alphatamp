"""
Approach that generates 3 heuristics, selects the best, runs planning once, and stops.
No reprompting or retry on failure.
"""
...
class DumbHeuristicLLMApproach(BaseApproach[_O, _X, _U]):
    """Generates 3 candidate heuristics, selects the best, runs planning once. No retry."""

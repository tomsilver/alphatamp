...
Data pipeline + model subpackage. See ``SPECTRE_RT2D_METHOD_SPEC.md`` for the
RT2D-specific method and training spec; ``SPECTRE_METHOD_SPEC.md`` for the
original (kinder-env) method spec; and ``SPECTRE_TRAINING_PIPELINE_SPEC.md``
for the data-collection pipeline motivation.
"""

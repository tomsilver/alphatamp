...
### Set Up the Code
2. **Clone this repository** and give it the name of your repo: `git clone git@github.com:tomsilver/alphatamp.git <NAME>`. You now have a directory called NAME. **Enter** it: `cd <NAME>`.

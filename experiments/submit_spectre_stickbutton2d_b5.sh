...
# (see experiments/conf/hydra/launcher/slurm.yaml).
#
...
# experiments/conf/spectre_collect.yaml, matching the ClutteredStorage2D
# collection convention).
#
# Usage from the repo root:
#
#   ./experiments/submit_spectre_stickbutton2d_b5.sh
#
...
After all three jobs finish, build the vocab from the train split:
  python experiments/spectre_build_vocab.py env=${ENV_VARIANT} data_root=${DATA_ROOT}
EOF
